...
<!-- Modals for editing  assignments -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="AffectationTraceurVehiculeController" method="post">
                    ...
                    <input type="hidden" name="originalDateDebut" value="${vehiculeTrac.vehiculetrackerPK.dateDebut}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="AffectationTraceurVehiculeController?action=assign" method="get">
               <!--   <form action="AffectationTraceurVehiculeController" method="post">-->
